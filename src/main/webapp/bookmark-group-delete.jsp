...
<br/>
<br/>
<form action="bookmark-group-delete-submit.jsp" method="post" onsubmit="event.preventDefault(); submitForm(this);">
  <table>
    <colgroups>
      <col style="width: 20%;" />
      <col style="width: 80%;" />
    ...
    <tr>
      <td colspan="2"><a href="bookmark-group.jsp">돌아가기</a><p> | </p><input type="submit" value="삭제"></td>
    </tr>
  </table>
</form>
</body>
